$( document ).ready(function() {
  ...
  drawBarChart([7, 3, 2.8765, 1, -0.01], {backgroundColour: 'rgb(255, 255, 0)', title: 'pure yellow is hard to work with...', caption: '...but the default settings still do a decent job'}, '#chart11');
});
